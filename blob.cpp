...
Blob::Blob(std::vector<cv::Point> _contour) {
	...
	/*boundingRect:The function computes a contour area. Similarly to moments , the area is computed using the Green formula*/
	...
	blnHaveBeenCrossingLine = false;
	blnCurrentMatchFoundOrNewBlob = true;

	intNumOfTrackedCar = 0;
